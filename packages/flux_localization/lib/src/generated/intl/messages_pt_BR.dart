...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "É necessário no mínimo ${count} caracteres";
  ...
  static String m47(store) => "Mais de ${store}";

  static String m48(number) => "Deve ser comprado em grupos de ${number}";

  static String m49(itemCount) => "${itemCount} itens";

  static String m50(amount) => "Pagar ${amount}";

  static String m51(date) => "Pagamento até: ${date}";

  static String m52(name) => "${name} foi adicionado ao carrinho com sucesso";

  static String m53(total) => "Qtd: ${total}";

  static String m54(name) => "Recebeu dinheiro de ${name}";

  static String m55(count) =>
      "Deseja remover ${count} item(ns) da sua lista de desejos?";

  static String m56(percent) => "${percent}% de desconto";

  static String m57(keyword, count) => "${keyword} (${count} item)";

  static String m58(keyword, count) => "${keyword} (${count} itens)";
  ...
  static String m62(fieldName) => "O campo ${fieldName} é obrigatório";

  static String m63(total) => "${total} produtos";

  static String m64(name) => "Transferir dinheiro para ${name}";

  static String m65(price) => "Até ${price}";

  static String m66(amount) => "Usar ${amount} pontos";
  ...
  static String m69(date) => "Válido até ${date}";

  static String m70(number) => "Versão ${number}";

  static String m71(balance) => "Saldo da carteira: ${balance}";

  static String m72(message) => "Aviso: ${message}";
  ...
  static String m75(name) => "Bem-vindo(a), ${name}";
  ...
  static String m78(point) => "Você tem ${point} pontos";

  static String m79(price) => "Você economizou ${price}";
