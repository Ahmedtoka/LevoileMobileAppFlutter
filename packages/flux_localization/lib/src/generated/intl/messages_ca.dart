...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Es requereixen un mínim de ${count} caràcters";
  ...
  static String m46(value) => "Transacció mínima: ${value}";

  static String m47(store) => "Més de ${store}";

  static String m48(number) => "s\'ha de comprar en grups de ${number}";

  static String m49(itemCount) => "${itemCount} articles";

  static String m50(amount) => "Pagar ${amount}";

  static String m51(date) => "Pagament pendent: ${date}";

  static String m52(name) => " S\'han afegit${name} al carretó correctament";

  static String m53(total) => "Quantitat: ${total}";

  static String m54(name) => "S\'ha rebut diners de ${name}";

  static String m55(count) =>
      "Vols eliminar ${count} element(s) de la teva llista de desitjos?";

  static String m56(percent) => "${percent}% de descompte";

  static String m57(keyword, count) => "${keyword} (${count} element)";

  static String m58(keyword, count) => "${keyword} (${count} elements)";

  static String m59(totalCartQuantity) =>
      "Carret de compra, ${totalCartQuantity} articles";

  static String m60(numberOfUnitsSold) => "Venut: ${numberOfUnitsSold}";

  static String m61(price) => "A partir de ${price}";

  static String m62(fieldName) => "El camp ${fieldName} és obligatori";

  static String m63(total) => "${total} productes";

  static String m64(name) => "Transfereix diners a ${name}";

  static String m65(price) => "Fins a ${price}";

  static String m66(amount) => "Utilitza ${amount} punts";
  ...
  static String m68(time) => "Vàlid fins: ${time}";

  static String m69(date) => "Vàlid fins al ${date}";

  static String m70(number) => "Versió ${number}";

  static String m71(balance) => "Saldo de Wallet: ${balance}";

  static String m72(message) => "Avís: ${message}";
  ...
  static String m74(week) => "Setmana ${week}";

  static String m75(name) => "Benvingut/da ${name}";
  ...
  static String m79(price) => "Has estalviat ${price}";
