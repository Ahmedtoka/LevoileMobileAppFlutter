...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Minimum ${count} tegn kreves";
  ...
  static String m46(value) => "Min. transaksjon: ${value}";

  static String m47(store) => "Mer fra ${store}";

  static String m48(number) => "Må kjøpes i grupper på ${number}";

  static String m49(itemCount) => "${itemCount} varer";

  static String m50(amount) => "Betal ${amount}";

  static String m51(date) => "Betaling forfaller: ${date}";

  static String m52(name) => "${name} er lagt til i handlekurven";

  static String m53(total) => "Antall: ${total}";

  static String m54(name) => "Mottok penger fra ${name}";

  static String m55(count) =>
      "Vil du fjerne ${count} element(er) fra ønskelisten din?";

  static String m56(percent) => "Salg ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} element)";

  static String m58(keyword, count) => "${keyword} (${count} elementer)";
  ...
  static String m61(price) => "Fra ${price}";

  static String m62(fieldName) => "Feltet ${fieldName} er påkrevd";

  static String m63(total) => "${total} produkter";

  static String m64(name) => "Overfør penger til ${name}";

  static String m65(price) => "Opptil ${price}";

  static String m66(amount) => "Bruk ${amount} poeng";
  ...
  static String m68(time) => "Gyldig til: ${time}";

  static String m69(date) => "Gyldig til ${date}";

  static String m70(number) => "Versjon ${number}";
  ...
  static String m74(week) => "Uke ${week}";

  static String m75(name) => "Velkommen ${name}";

  static String m76(count) => "Du har valgt ${count} element(er)";

  static String m77(type) => "Du har bestått ${type}";

  static String m78(point) => "Du har ${point} poeng";

  static String m79(price) => "Du sparte ${price}";
