...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m40(maxQuantity) => "カートに追加できる最大数量は${maxQuantity}です";

  static String m41(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m42(currency, amount) => "この支払いの最低額は${currency} ${amount}です";

  static String m43(count) => "最低${count}文字が必要です";

  static String m44(storeName, minOrderAmount) =>
      " ${storeName} の最低注文金額は ${minOrderAmount}です。このストアからさらに商品を追加してください。";

  static String m45(amount) => "このクーポンは最低 ${amount}の購入が必要です。";

  static String m46(value) => "最小取引: ${value}";

  static String m47(store) => "${store}の他の商品";

  static String m48(number) => "${number}個単位で購入する必要があります";

  static String m49(itemCount) => "${itemCount}点";

  static String m50(amount) => "${amount}を支払う";

  static String m51(date) => "支払期日：${date}";

  static String m52(name) => "${name}をカートに追加しました";

  static String m53(total) => "数量：${total}";

  static String m54(name) => "${name}から入金がありました";

  static String m55(count) => "${count}個の商品をお気に入りから削除しますか？";

  static String m56(percent) => "セール ${percent}%オフ";

  static String m57(keyword, count) => "${keyword}（${count}件）";

  static String m58(keyword, count) => "${keyword}（${count}件）";

  static String m59(totalCartQuantity) => "カート内の商品：${totalCartQuantity}点";

  static String m60(numberOfUnitsSold) => "売れた数：${numberOfUnitsSold}";

  static String m61(price) => "${price}から開始";

  static String m62(fieldName) => "${fieldName}は必須項目です";

  static String m63(total) => "商品数：${total}";

  static String m64(name) => "${name}に送金";

  static String m65(price) => "最大${price}まで";

  static String m66(amount) => " ${amount} ポイントを使用する";

  static String m67(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大${maxPointDiscount}ポイントを使用すると、${maxPriceDiscount}の割引が適用されます。";

  static String m68(time) => "有効期限: ${time}";

  static String m69(date) => "${date}まで有効";

  static String m70(number) => "バージョン ${number}";

  static String m71(balance) => "ウォレット残高：${balance}";

  static String m72(message) => "警告：${message}";

  static String m73(defaultCurrency) =>
      "現在選択されている通貨はウォレット機能では利用できません。${defaultCurrency}に変更してください";

  static String m74(week) => "週 ${week}";

  static String m75(name) => "ようこそ、${name}さん";

  static String m76(count) => "${count}個の商品を選択中";

  static String m77(type) => " ${type}に合格しました";

  static String m78(point) => "${point}ポイントあります";

  static String m79(price) => "${price}節約できました";
