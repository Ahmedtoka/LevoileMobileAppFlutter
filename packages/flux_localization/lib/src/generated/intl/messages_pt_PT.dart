...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "São necessários no mínimo ${count} caracteres";
  ...
  static String m56(percent) => "Desconto ${percent}%";
  ...
  static String m66(amount) => "Use ${amount} pontos";
  ...
  static String m75(name) => "Bem-vindo ${name}";

  static String m76(count) => "Está a selecionar ${count} item(ns)";

  static String m77(type) => "";

  static String m78(point) => "Tem ${point} pontos";

  static String m79(price) => "Poupa ${price}";
