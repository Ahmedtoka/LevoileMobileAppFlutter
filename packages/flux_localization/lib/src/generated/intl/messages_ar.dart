...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "مطلوب على الأقل ${count} أحرف";
  ...
  static String m46(value) => "الحد الأدنى للمعاملة: ${value}";

  static String m47(store) => "المزيد من ${store}";

  static String m48(number) => "يجب الشراء بمجموعات من ${number}";

  static String m49(itemCount) => "${itemCount} عنصر";

  static String m50(amount) => "ادفع ${amount}";

  static String m51(date) => "الدفع مستحق في: ${date}";

  static String m52(name) => "تمت إضافة ${name} إلى السلة بنجاح";

  static String m53(total) => "الكمية: ${total}";

  static String m54(name) => "استلمت مبلغاً من ${name}";

  static String m55(count) => "هل تريد إزالة ${count} عنصر من قائمة رغباتك؟";

  static String m56(percent) => "خصم ${percent}٪";

  static String m57(keyword, count) => "${keyword} (${count} عنصر)";

  static String m58(keyword, count) => "${keyword} (${count} عنصر)";

  static String m59(totalCartQuantity) =>
      "سلة التسوق، ${totalCartQuantity} عنصر";

  static String m60(numberOfUnitsSold) => "تم البيع: ${numberOfUnitsSold}";

  static String m61(price) => "يبدأ من ${price}";

  static String m62(fieldName) => "حقل ${fieldName} مطلوب";

  static String m63(total) => "${total} منتج";

  static String m64(name) => "تحويل مبلغ إلى ${name}";

  static String m65(price) => "حتى ${price}";

  static String m66(amount) => "استخدم ${amount} نقطة";
  ...
  static String m68(time) => "صالحة حتى: ${time}";

  static String m69(date) => "صالح حتى ${date}";

  static String m70(number) => "الإصدار ${number}";

  static String m71(balance) => "رصيد المحفظة: ${balance}";

  static String m72(message) => "تحذير: ${message}";

  static String m73(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m74(week) => "الأسبوع ${week}";

  static String m75(name) => "مرحباً ${name}";

  static String m76(count) => "أنت تختار ${count} عنصر";

  static String m77(type) => "لقد اجتزت ${type}";

  static String m78(point) => "لديك ${point} نقطة";

  static String m79(price) => "لقد وفرت ${price}";
