...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "အနည်းဆုံး ${count} အက္ခရာ လိုအပ်သည်";
  ...
  static String m46(value) => "အနည်းဆုံး ငွေပေးငွေယူ- ${value}";

  static String m47(store) => " ${store}မှ နောက်ထပ်";

  static String m48(number) => " ${number}အုပ်စုဖြင့် ဝယ်ယူရမည်";

  static String m49(itemCount) => "ပစ္စည်း ${itemCount} ခု";

  static String m50(amount) => " ${amount}ပေးချေပါ";

  static String m51(date) => "ငွေပေးချေရန်နေ့: ${date}";

  static String m52(name) =>
      "${name} ကို လှည်းသို့ အောင်မြင်စွာ ပေါင်းထည့်လိုက်ပါပြီ။";

  static String m53(total) => "Qty: ${total}";

  static String m54(name) => " ${name}ထံမှ ငွေလက်ခံရရှိသည် ";

  static String m55(count) =>
      "သင့်ဆန္ဒစာရင်းမှ အရာ ${count} ခုကို ဖယ်ရှားလိုပါသလား။";

  static String m56(percent) => "${percent}% လျှော့စျေး";

  static String m57(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m58(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m59(totalCartQuantity) =>
      "စျေးခြင်း၊ ပစ္စည်း ${totalCartQuantity} ခု";

  static String m60(numberOfUnitsSold) => "ရောင်းသည်- ${numberOfUnitsSold}";

  static String m61(price) => "စျေးနှုန်း ${price} မှ စတင်သည်";

  static String m62(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";

  static String m63(total) => " ထုတ်ကုန်${total} ခု";

  static String m64(name) => " ${name}သို့ ငွေလွှဲပါ ";

  static String m65(price) => "အမြင့်ဆုံး ${price} ထိ";

  static String m66(amount) => "အမှတ် ${amount} ကို သုံးပါ။";
  ...
  static String m68(time) => "အကျုံးဝင်သည်- ${time}";

  static String m69(date) => " ${date}အထိ အကျုံးဝင်သည် ";

  static String m70(number) => "ဗားရှင်း ${number}";

  static String m71(balance) => "ပိုက်ဆံအိတ်လက်ကျန်- ${balance}";

  static String m72(message) => "သတိပေးချက်: ${message}";
  ...
  static String m74(week) => "အပတ် ${week}";

  static String m75(name) => "ကြိုဆိုပါတယ် ${name}";

  static String m76(count) => "သင်သည် အရာ ${count} ခုကို ရွေးနေသည်";

  static String m77(type) => "သင် ${type}ကျော်သွားပါပြီ ";

  static String m78(point) => "သင့်တွင် ပွိုင့် ${point} ရှိပါသည်";

  static String m79(price) => "သင် ${price} ချွေတာနိုင်ခဲ့ပါတယ်";
