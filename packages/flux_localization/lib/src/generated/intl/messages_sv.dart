...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Minst ${count} tecken krävs";
  ...
  static String m46(value) => "Minsta transaktion: ${value}";

  static String m47(store) => "Mer från ${store}";

  static String m48(number) => "Måste köpas i grupper om ${number}";

  static String m49(itemCount) => "${itemCount} artiklar";

  static String m50(amount) => "Betala ${amount}";

  static String m51(date) => "Betalning förfaller: ${date}";

  static String m52(name) => "${name} har lagts till i kundvagnen";

  static String m53(total) => "Antal: ${total}";

  static String m54(name) => "Tog emot pengar från ${name}";

  static String m55(count) =>
      "Vill du ta bort ${count} artikel/artiklar från din önskelista?";

  static String m56(percent) => "Rea ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} objekt)";

  static String m58(keyword, count) => "${keyword} (${count} objekt)";

  static String m59(totalCartQuantity) =>
      "Kundvagn, ${totalCartQuantity} artiklar";

  static String m60(numberOfUnitsSold) => "Såld: ${numberOfUnitsSold}";

  static String m61(price) => "Startar från ${price}";

  static String m62(fieldName) => "Fältet ${fieldName} är obligatoriskt";

  static String m63(total) => "${total} produkter";

  static String m64(name) => "Överför pengar till ${name}";

  static String m65(price) => "Upp till ${price}";

  static String m66(amount) => "Använd ${amount} poäng";
  ...
  static String m68(time) => "Giltig till: ${time}";

  static String m69(date) => "Giltig till ${date}";

  static String m70(number) => "Version ${number}";

  static String m71(balance) => "Plånbokssaldo: ${balance}";

  static String m72(message) => "Varning: ${message}";
  ...
  static String m74(week) => "Vecka ${week}";

  static String m75(name) => "Välkommen ${name}";

  static String m76(count) => "Du väljer ${count} artikel/artiklar";

  static String m77(type) => "Du har klarat ${type}";

  static String m78(point) => "Du har ${point} poäng";

  static String m79(price) => "Du sparade ${price}";
