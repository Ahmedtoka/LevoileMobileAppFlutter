...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Minimum ${count} tegn kræves";
  ...
  static String m46(value) => "Minimumstransaktion: ${value}";

  static String m47(store) => "Mere fra ${store}";

  static String m48(number) => "Skal købes i grupper af ${number}";

  static String m49(itemCount) => "${itemCount} elementer";

  static String m50(amount) => "Betal ${amount}";

  static String m51(date) => "Betaling forfalder: ${date}";

  static String m52(name) => "${name} er blevet tilføjet til indkøbskurven";

  static String m53(total) => "Antal: ${total}";

  static String m54(name) => "Modtog penge fra ${name}";

  static String m55(count) =>
      "Vil du fjerne ${count} vare(r) fra din ønskeliste?";

  static String m56(percent) => "Udsalg ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} vare)";

  static String m58(keyword, count) => "${keyword} (${count} varer)";

  static String m59(totalCartQuantity) =>
      "Indkøbskurv, ${totalCartQuantity} varer";

  static String m60(numberOfUnitsSold) => "Solgt: ${numberOfUnitsSold}";

  static String m61(price) => "Starter fra ${price}";

  static String m62(fieldName) => "Feltet ${fieldName} er påkrævet";

  static String m63(total) => "${total} produkter";

  static String m64(name) => "Overfør penge til ${name}";

  static String m65(price) => "Op til ${price}";

  static String m66(amount) => "Brug ${amount} point";
  ...
  static String m68(time) => "Gyldig indtil: ${time}";

  static String m69(date) => "Gyldig til ${date}";

  static String m70(number) => "Version ${number}";

  static String m71(balance) => "Saldo: ${balance}";

  static String m72(message) => "Advarsel: ${message}";
  ...
  static String m74(week) => "Uge ${week}";

  static String m75(name) => "Velkommen ${name}";

  static String m76(count) => "Du vælger ${count} vare(r)";

  static String m77(type) => "Du har bestået ${type}";

  static String m78(point) => "Du har ${point} point";

  static String m79(price) => "Du sparede ${price}";
