...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Требуется минимум ${count} символов";
  ...
  static String m46(value) => "Минимальная транзакция: ${value}";

  static String m47(store) => "Еще из ${store}";

  static String m48(number) => "Необходимо покупать группами по ${number}";

  static String m49(itemCount) => "${itemCount} товаров";

  static String m50(amount) => "Оплатить ${amount}";

  static String m51(date) => "Оплата до: ${date}";

  static String m52(name) => "Товар ${name} добавлен в корзину";

  static String m53(total) => "Кол-во: ${total}";

  static String m54(name) => "Получены деньги от ${name}";

  static String m55(count) => "Удалить ${count} товар(ов) из списка желаний?";

  static String m56(percent) => "Скидка ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} товар)";

  static String m58(keyword, count) => "${keyword} (${count} товаров)";
  ...
  static String m61(price) => "От ${price}";

  static String m62(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m63(total) => "${total} товаров";

  static String m64(name) => "Перевести деньги пользователю ${name}";

  static String m65(price) => "До ${price}";

  static String m66(amount) => "Используйте ${amount} баллов";
  ...
  static String m68(time) => "Действительно до: ${time}";

  static String m69(date) => "Действительно до ${date}";

  static String m70(number) => "Версия ${number}";

  static String m71(balance) => "Баланс кошелька: ${balance}";
  ...
  static String m74(week) => "Неделя ${week}";

  static String m75(name) => "Добро пожаловать, ${name}";
  ...
  static String m79(price) => "Вы сэкономили ${price}";
