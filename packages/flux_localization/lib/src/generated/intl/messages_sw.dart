...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Angalau herufi ${count} zinahitajika";
  ...
  static String m46(value) => "Kiwango cha chini cha muamala: ${value}";

  static String m47(store) => "Zaidi kutoka ${store}";

  static String m48(number) => "Lazima inunuliwe katika vikundi vya ${number}";

  static String m49(itemCount) => "Vitu ${itemCount}";

  static String m50(amount) => "Lipa ${amount}";

  static String m51(date) => "Malipo yanayostahili: ${date}";

  static String m52(name) => "${name} imeongezwa kwenye kikapu";

  static String m53(total) => "Kiasi: ${total}";

  static String m54(name) => "Umepokea pesa kutoka kwa ${name}";

  static String m55(count) =>
      "Je, ungependa kuondoa vipengee ${count} kutoka kwenye orodha yako ya matamanio?";

  static String m56(percent) => "Punguzo ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m58(keyword, count) => "${keyword} (${count} bidhaa)";

  static String m59(totalCartQuantity) =>
      "Kikapu cha ununuzi, vitu ${totalCartQuantity}";

  static String m60(numberOfUnitsSold) => "Imeuzwa: ${numberOfUnitsSold}";

  static String m61(price) => "Inaanzia ${price}";

  static String m62(fieldName) => "Sehemu ya ${fieldName} inahitajika";

  static String m63(total) => "Jumla ya Bidhaa: ${total}";

  static String m64(name) => "Hamisha pesa kwa ${name}";

  static String m65(price) => "Hadi ${price}";

  static String m66(amount) => "Tumia pointi ${amount} ";
  ...
  static String m68(time) => "Itatumika hadi: ${time}";

  static String m69(date) => "Halali hadi ${date}";

  static String m70(number) => "Toleo la ${number}";

  static String m71(balance) => "Salio la Pochi: ${balance}";

  static String m72(message) => "Onyo: ${message}";
  ...
  static String m74(week) => "Wiki ${week}";

  static String m75(name) => "Karibu ${name}";

  static String m76(count) => "Unachagua vipengee ${count} ";

  static String m77(type) => "Umepita ${type}";

  static String m78(point) => "Una pointi ${point}";

  static String m79(price) => "Umeokoa ${price}";
