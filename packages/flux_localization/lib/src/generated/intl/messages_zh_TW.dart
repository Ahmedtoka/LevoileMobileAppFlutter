...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m40(maxQuantity) => "購物車中允許的最大數量為 ${maxQuantity}";

  static String m41(name, formattedPrice) => "${name}： ${formattedPrice}";

  static String m42(currency, amount) => "使用此付款方式的最低金額為${currency} ${amount}";

  static String m43(count) => "至少需要 ${count} 個字元";

  static String m44(storeName, minOrderAmount) =>
      " ${storeName} 的最低訂單金額為 ${minOrderAmount}。請從該商店添加更多商品！";

  static String m45(amount) => "此優惠券要求最低購買金額為 ${amount}。";

  static String m46(value) => "最低交易次數： ${value}";

  static String m47(store) => "${store}的更多商品";

  static String m48(number) => "必須以${number}為一組購買";

  static String m49(itemCount) => "${itemCount} 個項目";

  static String m50(amount) => "支付${amount}";

  static String m51(date) => "付款截止日期：${date}";

  static String m52(name) => "${name}已成功加入購物車";

  static String m53(total) => "數量：${total}";

  static String m54(name) => "收到來自${name}的款項";

  static String m55(count) => "您想從心願清單中刪除 ${count} 件商品嗎？";

  static String m56(percent) => "特價 ${percent}%";

  static String m57(keyword, count) => "${keyword}（${count}項）";

  static String m58(keyword, count) => "${keyword}（${count}項）";

  static String m59(totalCartQuantity) => "購物車，${totalCartQuantity}件商品";

  static String m60(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m61(price) => "起價 ${price}";

  static String m62(fieldName) => "${fieldName}為必填欄位";

  static String m63(total) => "${total}項商品";

  static String m64(name) => "轉帳給${name}";

  static String m65(price) => "最高 ${price}";

  static String m66(amount) => "使用 ${amount} 積分";

  static String m67(maxPointDiscount, maxPriceDiscount) =>
      "使用最多${maxPointDiscount}點積分可獲得此訂單${maxPriceDiscount}的折扣！";

  static String m68(time) => "有效期限至： ${time}";

  static String m69(date) => "有效期至 ${date}";

  static String m70(number) => "版本 ${number}";

  static String m71(balance) => "錢包餘額：${balance}";

  static String m72(message) => "警告：${message}";

  static String m73(defaultCurrency) => "目前選擇的貨幣不適用於錢包功能，請改為${defaultCurrency}";

  static String m74(week) => "第${week}週";

  static String m75(name) => "歡迎${name}";
  ...
  static String m79(price) => "您已節省 ${price}";
