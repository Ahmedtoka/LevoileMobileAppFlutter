...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Wymagane minimum ${count} znaków";
  ...
  static String m46(value) => "Minimalna transakcja: ${value}";

  static String m47(store) => "Więcej od ${store}";

  static String m48(number) => "Musi być kupowane w grupach po ${number}";

  static String m49(itemCount) => "${itemCount} elementów";

  static String m50(amount) => "Zapłać ${amount}";

  static String m51(date) => "Płatność do: ${date}";

  static String m52(name) => "Produkt ${name} został dodany do koszyka";

  static String m53(total) => "Ilość: ${total}";

  static String m54(name) => "Otrzymano środki od ${name}";

  static String m55(count) =>
      "Czy chcesz usunąć ${count} pozycji z listy życzeń?";

  static String m56(percent) => "Wyprzedaż ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} element)";

  static String m58(keyword, count) => "${keyword} (${count} elementów)";

  static String m59(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycji";

  static String m60(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m61(price) => "Cena od ${price}";

  static String m62(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m63(total) => "${total} produktów";

  static String m64(name) => "Przelej pieniądze do ${name}";

  static String m65(price) => "Do ${price}";

  static String m66(amount) => "Użyj ${amount} punktów";
  ...
  static String m68(time) => "Ważne do: ${time}";

  static String m69(date) => "Ważne do ${date}";

  static String m70(number) => "Wersja ${number}";

  static String m71(balance) => "Saldo portfela: ${balance}";

  static String m72(message) => "Ostrzeżenie: ${message}";
  ...
  static String m74(week) => "Tydzień ${week}";

  static String m75(name) => "Witaj ${name}";
  ...
  static String m79(price) => "Zaoszczędziłeś ${price}";
