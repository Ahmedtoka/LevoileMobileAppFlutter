...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Mindestens ${count} Zeichen erforderlich";
  ...
  static String m46(value) => "Mindesttransaktion: ${value}";

  static String m47(store) => "Mehr von ${store}";

  static String m48(number) => "Muss in Gruppen von ${number} gekauft werden";

  static String m49(itemCount) => "${itemCount} Artikel";

  static String m50(amount) => "${amount} bezahlen";

  static String m51(date) => "Zahlung fällig: ${date}";

  static String m52(name) => "${name} wurde zum Warenkorb hinzugefügt";

  static String m53(total) => "Menge: ${total}";

  static String m54(name) => "Geld erhalten von ${name}";

  static String m55(count) =>
      "Möchten Sie ${count} Artikel von Ihrer Wunschliste entfernen?";

  static String m56(percent) => "${percent}% Rabatt";

  static String m57(keyword, count) => "${keyword} (${count} Artikel)";

  static String m58(keyword, count) => "${keyword} (${count} Artikel)";

  static String m59(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m60(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m61(price) => "Ab ${price}";

  static String m62(fieldName) => "Das Feld ${fieldName} ist erforderlich";

  static String m63(total) => "${total} Produkte";

  static String m64(name) => "Geld überweisen an ${name}";

  static String m65(price) => "Bis zu ${price}";

  static String m66(amount) => "${amount} Punkte einlösen";
  ...
  static String m68(time) => "Gültig bis: ${time}";

  static String m69(date) => "Gültig bis ${date}";

  static String m70(number) => "Version ${number}";

  static String m71(balance) => "Guthaben: ${balance}";

  static String m72(message) => "Warnung: ${message}";
  ...
  static String m74(week) => "Woche ${week}";

  static String m75(name) => "Willkommen ${name}";
  ...
  static String m79(price) => "Du hast ${price} gespart";
