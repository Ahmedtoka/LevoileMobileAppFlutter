...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Изискват се минимум ${count} знака";
  ...
  static String m46(value) => "Минимална транзакция: ${value}";

  static String m47(store) => "Още от ${store}";

  static String m48(number) => "трябва да се купува в групи по ${number}";

  static String m49(itemCount) => "${itemCount} продукта";

  static String m50(amount) => "Платете ${amount}";

  static String m51(date) => "Плащане до: ${date}";

  static String m52(name) => "${name} е добавен успешно в количката";

  static String m53(total) => "Количество: ${total}";

  static String m54(name) => "Получени пари от ${name}";

  static String m55(count) =>
      "Искате ли да премахнете ${count} артикула от вашия списък с желания?";

  static String m56(percent) => "Разпродажба ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} резултат)";

  static String m58(keyword, count) => "${keyword} (${count} резултата)";

  static String m59(totalCartQuantity) =>
      "Количка, ${totalCartQuantity} продукта";

  static String m60(numberOfUnitsSold) => "Продадени: ${numberOfUnitsSold}";

  static String m61(price) => "Започва от ${price}";

  static String m62(fieldName) => "Полето ${fieldName} е задължително";

  static String m63(total) => "${total} продукта";

  static String m64(name) => "Прехвърляне на пари към ${name}";

  static String m65(price) => "До ${price}";

  static String m66(amount) => "Използвайте ${amount} точки";
  ...
  static String m68(time) => "Валидно до: ${time}";

  static String m69(date) => "Валиден до ${date}";

  static String m70(number) => "Версия ${number}";

  static String m71(balance) => "Баланс в портфейла: ${balance}";

  static String m72(message) => "Предупреждение: ${message}";
  ...
  static String m74(week) => "Седмица ${week}";

  static String m75(name) => "Добре дошли, ${name}";

  static String m76(count) => "Избирате ${count} артикул(а)";

  static String m77(type) => "Вие преминахте ${type}";

  static String m78(point) => "Имате ${point} точки";

  static String m79(price) => "Спестихте ${price}";
