...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Se requieren al menos ${count} caracteres";
  ...
  static String m46(value) => "Transacción mínima: ${value}";

  static String m47(store) => "Más de ${store}";

  static String m48(number) => "Debe comprarse en grupos de ${number}";

  static String m49(itemCount) => "${itemCount} artículos";

  static String m50(amount) => "Pagar ${amount}";

  static String m51(date) => "Pago pendiente para: ${date}";

  static String m52(name) => "${name} agregado al carrito";

  static String m53(total) => "Cantidad: ${total}";

  static String m54(name) => "Recibiste dinero de ${name}";

  static String m55(count) =>
      "¿Quieres eliminar ${count} artículo(s) de tu lista de deseos?";

  static String m56(percent) => "Descuento ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} elemento)";

  static String m58(keyword, count) => "${keyword} (${count} elementos)";

  static String m59(totalCartQuantity) =>
      "Carrito, ${totalCartQuantity} artículos";

  static String m60(numberOfUnitsSold) => "Vendido: ${numberOfUnitsSold}";

  static String m61(price) => "Desde ${price}";

  static String m62(fieldName) => "El campo ${fieldName} es obligatorio";

  static String m63(total) => "${total} productos";

  static String m64(name) => "Transferir dinero a ${name}";

  static String m65(price) => "Hasta ${price}";

  static String m66(amount) => "Utiliza ${amount} puntos";
  ...
  static String m68(time) => "Válido hasta: ${time}";

  static String m69(date) => "Válido hasta ${date}";

  static String m70(number) => "Versión ${number}";

  static String m71(balance) => "Saldo de la billetera: ${balance}";

  static String m72(message) => "Advertencia: ${message}";
  ...
  static String m74(week) => "Semana ${week}";

  static String m75(name) => "Bienvenido ${name}";

  static String m76(count) => "Estás seleccionando ${count} artículo(s)";

  static String m77(type) => "Has superado ${type}";

  static String m78(point) => "Tienes ${point} puntos";

  static String m79(price) => "Has ahorrado ${price}";
