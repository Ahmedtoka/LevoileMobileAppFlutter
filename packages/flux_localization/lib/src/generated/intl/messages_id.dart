...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Minimal ${count} karakter diperlukan";
  ...
  static String m47(store) => "Lainnya dari ${store}";

  static String m48(number) => "Harus dibeli dalam kelompok ${number}";

  static String m49(itemCount) => "${itemCount} item";

  static String m50(amount) => "Bayar ${amount}";

  static String m51(date) => "Pembayaran jatuh tempo: ${date}";

  static String m52(name) => "${name} berhasil ditambahkan ke keranjang";

  static String m53(total) => "Jumlah: ${total}";

  static String m54(name) => "Menerima uang dari ${name}";

  static String m55(count) =>
      "Apakah Anda ingin menghapus ${count} item dari daftar keinginan?";

  static String m56(percent) => "Diskon ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} barang)";

  static String m58(keyword, count) => "${keyword} (${count} barang)";
  ...
  static String m61(price) => "Mulai dari ${price}";

  static String m62(fieldName) => "Bidang ${fieldName} wajib diisi";

  static String m63(total) => "${total} produk";

  static String m64(name) => "Transfer uang ke ${name}";

  static String m65(price) => "Hingga ${price}";

  static String m66(amount) => "Gunakan ${amount} poin";
  ...
  static String m68(time) => "Berlaku sampai: ${time}";

  static String m69(date) => "Berlaku hingga ${date}";

  static String m70(number) => "Versi ${number}";

  static String m71(balance) => "Saldo dompet: ${balance}";

  static String m72(message) => "Peringatan: ${message}";
  ...
  static String m79(price) => "Anda menghemat ${price}";
