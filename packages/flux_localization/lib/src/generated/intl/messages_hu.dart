...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Legalább ${count} karakter szükséges";
  ...
  static String m46(value) => "Minimális tranzakció: ${value}";

  static String m47(store) => "További termékek innen: ${store}";

  static String m48(number) => "${number} darabos csomagban vásárolható";

  static String m49(itemCount) => "${itemCount} termék";

  static String m50(amount) => "Fizetés: ${amount}";

  static String m51(date) => "Fizetés esedékes: ${date}";

  static String m52(name) => "A(z) ${name} sikeresen a kosárba került";

  static String m53(total) => "Mennyiség: ${total}";

  static String m54(name) => "Pénz érkezett tőle: ${name}";

  static String m55(count) =>
      "Eltávolít ${count} terméket a kívánságlistájáról?";

  static String m56(percent) => "${percent}% kedvezmény";

  static String m57(keyword, count) => "${keyword} (${count} találat)";

  static String m58(keyword, count) => "${keyword} (${count} találat)";

  static String m59(totalCartQuantity) => "Kosár, ${totalCartQuantity} termék";

  static String m60(numberOfUnitsSold) => "Eladva: ${numberOfUnitsSold}";

  static String m61(price) => "Kezdőár: ${price}";

  static String m62(fieldName) => "A(z) ${fieldName} mező kötelező";

  static String m63(total) => "${total} termék";

  static String m64(name) => "Pénz küldése neki: ${name}";

  static String m65(price) => "Legfeljebb ${price}";

  static String m66(amount) => "Használjon ${amount} pontot";
  ...
  static String m68(time) => "Érvényes eddig: ${time}";

  static String m69(date) => "Érvényes: ${date}";

  static String m70(number) => "Verzió: ${number}";

  static String m71(balance) => "Egyenleg: ${balance}";

  static String m72(message) => "Figyelmeztetés: ${message}";
  ...
  static String m74(week) => "${week}. hét";

  static String m75(name) => "Üdvözöljük, ${name}!";
  ...
  static String m79(price) => "Ön ${price} összeget spórolt meg";
