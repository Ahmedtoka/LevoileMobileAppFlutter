...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Yêu cầu tối thiểu ${count} ký tự";
  ...
  static String m46(value) => "Giao dịch tối thiểu: ${value}";

  static String m47(store) => "Thêm từ ${store}";

  static String m48(number) => "phải mua theo nhóm ${number}";

  static String m49(itemCount) => "${itemCount} sản phẩm";

  static String m50(amount) => "Thanh toán ${amount}";

  static String m51(date) => "Hạn thanh toán: ${date}";

  static String m52(name) => "${name} đã được thêm vào giỏ hàng thành công";

  static String m53(total) => "SL: ${total}";

  static String m54(name) => "Nhận tiền từ ${name}";

  static String m55(count) =>
      "Bạn có muốn xóa ${count} sản phẩm khỏi danh sách mong muốn của mình không?";

  static String m56(percent) => "Giảm ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} mục)";

  static String m58(keyword, count) => "${keyword} (${count} mục)";

  static String m59(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m60(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m61(price) => "Bắt đầu từ ${price}";

  static String m62(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m63(total) => "${total} sản phẩm";

  static String m64(name) => "Chuyển tiền đến ${name}";

  static String m65(price) => "Tối đa ${price}";

  static String m66(amount) => "Sử dụng ${amount} điểm";
  ...
  static String m68(time) => "Có hiệu lực đến: ${time}";

  static String m69(date) => "Có giá trị đến ${date}";

  static String m70(number) => "Phiên bản ${number}";

  static String m71(balance) => "Số dư ví: ${balance}";

  static String m72(message) => "Cảnh báo: ${message}";
  ...
  static String m74(week) => "Tuần ${week}";

  static String m75(name) => "Chào mừng ${name}";

  static String m76(count) => "Bạn đang chọn ${count} mục";

  static String m77(type) => "Bạn đã vượt qua ${type}";

  static String m78(point) => "Bạn có ${point} điểm";

  static String m79(price) => "Bạn đã tiết kiệm được ${price}";
