...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Sono richiesti almeno ${count} caratteri";
  ...
  static String m46(value) => "Transazione minima: ${value}";

  static String m47(store) => "Altri prodotti da ${store}";

  static String m48(number) => "Deve essere acquistato in gruppi di ${number}";

  static String m49(itemCount) => "${itemCount} articoli";

  static String m50(amount) => "Paga ${amount}";

  static String m51(date) => "Pagamento dovuto entro: ${date}";

  static String m52(name) => "${name} aggiunto al carrello";

  static String m53(total) => "Qtà: ${total}";

  static String m54(name) => "Ricevuto denaro da ${name}";

  static String m55(count) => "Vuoi rimuovere ${count} articoli dai preferiti?";

  static String m56(percent) => "Sconto ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} risultato)";

  static String m58(keyword, count) => "${keyword} (${count} risultati)";

  static String m59(totalCartQuantity) =>
      "Carrello, ${totalCartQuantity} articoli";

  static String m60(numberOfUnitsSold) => "Venduto: ${numberOfUnitsSold}";

  static String m61(price) => "A partire da ${price}";

  static String m62(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m63(total) => "${total} prodotti";

  static String m64(name) => "Trasferisci denaro a ${name}";

  static String m65(price) => "Fino a ${price}";

  static String m66(amount) => "Usa ${amount} punti";
  ...
  static String m68(time) => "Valido fino al: ${time}";

  static String m69(date) => "Valido fino al ${date}";

  static String m70(number) => "Versione ${number}";

  static String m71(balance) => "Saldo portafoglio: ${balance}";

  static String m72(message) => "Attenzione: ${message}";
  ...
  static String m74(week) => "Settimana ${week}";

  static String m75(name) => "Benvenuto ${name}";
  ...
  static String m79(price) => "Hai risparmiato ${price}";
