...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "En az ${count} karakter gerekli";
  ...
  static String m46(value) => "Min işlem: ${value}";

  static String m47(store) => "${store} mağazasından daha fazlası";

  static String m48(number) =>
      "${number} adetlik gruplar halinde satın alınmalıdır";

  static String m49(itemCount) => "${itemCount} ürün";

  static String m50(amount) => "${amount} ile öde";

  static String m51(date) => "Ödeme tarihi: ${date}";

  static String m52(name) => "${name} sepete eklendi";

  static String m53(total) => "Adet: ${total}";

  static String m54(name) => "${name} tarafından para alındı";

  static String m55(count) =>
      "İstek listenizden ${count} ürünü kaldırmak istiyor musunuz?";

  static String m56(percent) => "%${percent} İndirim";

  static String m57(keyword, count) => "${keyword} (${count} ürün)";

  static String m58(keyword, count) => "${keyword} (${count} ürün)";

  static String m59(totalCartQuantity) => "Sepet, ${totalCartQuantity} ürün";

  static String m60(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m61(price) => "${price} başlangıç fiyatı";

  static String m62(fieldName) => "${fieldName} alanı zorunludur";

  static String m63(total) => "${total} ürün";

  static String m64(name) => "${name} hesabına para transferi";

  static String m65(price) => "En fazla ${price}";

  static String m66(amount) => " ${amount} puan kullan";
  ...
  static String m68(time) => "Geçerlilik tarihi: ${time}";

  static String m69(date) => "${date} tarihine kadar geçerli";

  static String m70(number) => "Sürüm ${number}";

  static String m71(balance) => "Cüzdan bakiyesi: ${balance}";

  static String m72(message) => "Uyarı: ${message}";
  ...
  static String m75(name) => "Hoş geldin ${name}";
  ...
  static String m79(price) => "${price} kadar tasarruf ettiniz";
