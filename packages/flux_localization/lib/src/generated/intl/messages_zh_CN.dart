...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m48(number) => "必须以${number}为一组购买";
  ...
  static String m52(name) => "${name}已添加到购物车";

  static String m53(total) => "数量：${total}";

  static String m54(name) => "已收到来自${name}的款项";

  static String m55(count) => "是否要从愿望清单中删除 ${count} 件商品？";

  static String m56(percent) => "促销 ${percent}%";

  static String m57(keyword, count) => "${keyword}（${count}个结果）";

  static String m58(keyword, count) => "${keyword}（${count}个结果）";
  ...
  static String m63(total) => "${total}件商品";
