...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Minimaal ${count} tekens vereist";
  ...
  static String m46(value) => "Minimale transactie: ${value}";

  static String m47(store) => "Meer van ${store}";

  static String m48(number) => "Moet worden gekocht in groepen van ${number}";

  static String m49(itemCount) => "${itemCount} items";

  static String m50(amount) => "Betaal ${amount}";

  static String m51(date) => "Betaling verschuldigd op: ${date}";

  static String m52(name) =>
      "${name} is succesvol aan de winkelwagen toegevoegd";

  static String m53(total) => "Aantal: ${total}";

  static String m54(name) => "Geld ontvangen van ${name}";

  static String m55(count) =>
      "Wilt u ${count} item(s) van uw verlanglijst verwijderen?";

  static String m56(percent) => "Aanbieding ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} artikel)";

  static String m58(keyword, count) => "${keyword} (${count} artikelen)";

  static String m59(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} items";

  static String m60(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m61(price) => "Vanaf ${price}";

  static String m62(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m63(total) => "${total} producten";

  static String m64(name) => "Geld overmaken naar ${name}";

  static String m65(price) => "Tot ${price}";

  static String m66(amount) => "Gebruik ${amount} punten";
  ...
  static String m68(time) => "Geldig tot: ${time}";

  static String m69(date) => "Geldig tot ${date}";

  static String m70(number) => "Versie ${number}";

  static String m71(balance) => "Saldo portemonnee: ${balance}";

  static String m72(message) => "Waarschuwing: ${message}";
  ...
  static String m74(week) => "Week ${week}";

  static String m75(name) => "Welkom ${name}";

  static String m76(count) => "U selecteert ${count} item(s)";

  static String m77(type) => "Je bent geslaagd voor ${type}";

  static String m78(point) => "Je hebt ${point} punten";

  static String m79(price) => "Je hebt ${price} bespaard";
