...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Vähintään ${count} merkkiä vaaditaan";
  ...
  static String m46(value) => "Minimitapahtuma: ${value}";

  static String m47(store) => "Lisää kaupasta ${store}";

  static String m48(number) => "Täytyy ostaa ${number} kappaleen ryhmissä";

  static String m49(itemCount) => "${itemCount} kohdetta";

  static String m50(amount) => "Maksa ${amount}";

  static String m51(date) => "Maksu erääntyy: ${date}";

  static String m52(name) => "${name} lisätty ostoskoriin";

  static String m53(total) => "Määrä: ${total}";

  static String m54(name) => "Vastaanotettu rahaa käyttäjältä ${name}";

  static String m55(count) =>
      "Haluatko poistaa ${count} tuotetta toivelistalta?";

  static String m56(percent) => "Ale ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} tulos)";

  static String m58(keyword, count) => "${keyword} (${count} tulosta)";

  static String m59(totalCartQuantity) =>
      "Ostoskori, ${totalCartQuantity} tuotetta";

  static String m60(numberOfUnitsSold) => "Myyty: ${numberOfUnitsSold}";

  static String m61(price) => "Alkaen ${price}";

  static String m62(fieldName) => "Kenttä ${fieldName} on pakollinen";

  static String m63(total) => "${total} tuotetta";

  static String m64(name) => "Siirrä rahaa käyttäjälle ${name}";

  static String m65(price) => "Jopa ${price}";

  static String m66(amount) => "Käytä ${amount} pistettä";
  ...
  static String m68(time) => "Voimassa asti: ${time}";

  static String m69(date) => "Voimassa ${date} asti";

  static String m70(number) => "Versio ${number}";

  static String m71(balance) => "Lompakon saldo: ${balance}";

  static String m72(message) => "Varoitus: ${message}";
  ...
  static String m74(week) => "Viikko ${week}";

  static String m75(name) => "Tervetuloa ${name}";

  static String m76(count) => "Olet valitsemassa ${count} tuotetta";

  static String m77(type) => "Olet ohittanut ${type}";

  static String m78(point) => "Sinulla on ${point} pistettä";

  static String m79(price) => "Säästit ${price}";
