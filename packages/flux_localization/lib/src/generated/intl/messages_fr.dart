...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Au moins ${count} caractères requis";
  ...
  static String m46(value) => "Transaction minimale : ${value}";

  static String m47(store) => "Plus de ${store}";

  static String m48(number) => "Doit être acheté par groupes de ${number}";

  static String m49(itemCount) => "${itemCount} articles";

  static String m50(amount) => "Payer ${amount}";

  static String m51(date) => "Paiement dû le : ${date}";

  static String m52(name) => "${name} a été ajouté au panier avec succès";

  static String m53(total) => "Qté : ${total}";

  static String m54(name) => "Reçu de l\'argent de ${name}";

  static String m55(count) =>
      "Voulez-vous retirer ${count} article(s) de votre liste de souhaits ?";

  static String m56(percent) => "Remise ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} article)";

  static String m58(keyword, count) => "${keyword} (${count} articles)";

  static String m59(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} articles";

  static String m60(numberOfUnitsSold) => "Vendu : ${numberOfUnitsSold}";

  static String m61(price) => "À partir de ${price}";

  static String m62(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m63(total) => "${total} produits";

  static String m64(name) => "Transférer de l\'argent à ${name}";

  static String m65(price) => "Jusqu\'à ${price}";

  static String m66(amount) => "Utilisez ${amount} points";
  ...
  static String m68(time) => "Valable jusqu\'au : ${time}";

  static String m69(date) => "Valable jusqu\'au ${date}";

  static String m70(number) => "Version ${number}";

  static String m71(balance) => "Solde du portefeuille : ${balance}";

  static String m72(message) => "Attention : ${message}";
  ...
  static String m74(week) => "Semaine ${week}";

  static String m75(name) => "Bienvenue ${name}";

  static String m76(count) => "Vous sélectionnez ${count} article(s)";

  static String m77(type) => "Vous avez réussi ${type}";

  static String m78(point) => "Vous avez ${point} points";

  static String m79(price) => "Vous avez économisé ${price}";
