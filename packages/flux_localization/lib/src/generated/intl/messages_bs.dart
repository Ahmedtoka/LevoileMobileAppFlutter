...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Potrebno je najmanje ${count} znakova";
  ...
  static String m46(value) => "Minimalna transakcija: ${value}";

  static String m47(store) => "Više od ${store}";

  static String m48(number) => "mora se kupiti u grupama od ${number}";

  static String m49(itemCount) => "${itemCount} artikala";

  static String m50(amount) => "Plati ${amount}";

  static String m51(date) => "Plaćanje do: ${date}";

  static String m52(name) => "${name} su uspješno dodani u korpu";

  static String m53(total) => "Količina: ${total}";

  static String m54(name) => "Primljen novac od ${name}";

  static String m55(count) =>
      "Želite li ukloniti sljedeći broj stavki: ${count} sa svoje liste želja?";

  static String m56(percent) => "Sniženje ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} stavka)";

  static String m58(keyword, count) => "${keyword} (${count} stavki)";

  static String m59(totalCartQuantity) =>
      "Korpa, ${totalCartQuantity} artikala";

  static String m60(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";

  static String m61(price) => "Počinje od ${price}";

  static String m62(fieldName) => "Polje ${fieldName} je obavezno";

  static String m63(total) => "${total} proizvoda";

  static String m64(name) => "Prenesite novac na ${name}";

  static String m65(price) => "Do ${price}";

  static String m66(amount) => "Iskoristite ${amount} poena";
  ...
  static String m68(time) => "Vrijedi do: ${time}";

  static String m69(date) => "Važi do ${date}";

  static String m70(number) => "Verzija ${number}";

  static String m71(balance) => "Stanje novčanika: ${balance}";

  static String m72(message) => "Upozorenje: ${message}";
  ...
  static String m74(week) => "Sedmica ${week}";

  static String m75(name) => "Dobro došli ${name}";

  static String m76(count) => "Odabirete sljedeći broj stavki: ${count} ";

  static String m77(type) => "Prošli ste ${type}";

  static String m78(point) => "Imate ${point} bodova";

  static String m79(price) => "Uštedjeli ste ${price}";
