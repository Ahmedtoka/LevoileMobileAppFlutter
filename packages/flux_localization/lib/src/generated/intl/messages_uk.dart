...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Потрібно щонайменше ${count} символів";
  ...
  static String m46(value) => "Мінімальна транзакція: ${value}";

  static String m47(store) => "Більше від ${store}";

  static String m48(number) => "Необхідно купувати групами по ${number}";

  static String m49(itemCount) => "${itemCount} товарів";

  static String m50(amount) => "Оплатити ${amount}";

  static String m51(date) => "Оплата до: ${date}";

  static String m52(name) => "${name} успішно додано до кошика";

  static String m53(total) => "Кількість: ${total}";

  static String m54(name) => "Отримано кошти від ${name}";

  static String m55(count) =>
      "Бажаєте видалити ${count} товарів зі списку бажань?";

  static String m56(percent) => "Знижка ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} товар)";

  static String m58(keyword, count) => "${keyword} (${count} товарів)";

  static String m59(totalCartQuantity) => "Кошик, ${totalCartQuantity} товарів";

  static String m60(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m61(price) => "Від ${price}";

  static String m62(fieldName) => "Поле ${fieldName} є обов\'язковим";

  static String m63(total) => "${total} товарів";

  static String m64(name) => "Переказати кошти ${name}";

  static String m65(price) => "До ${price}";

  static String m66(amount) => "Використати ${amount} балів";
  ...
  static String m68(time) => "Дійсний до: ${time}";

  static String m69(date) => "Дійсний до ${date}";

  static String m70(number) => "Версія ${number}";

  static String m71(balance) => "Баланс гаманця: ${balance}";

  static String m72(message) => "Попередження: ${message}";
  ...
  static String m74(week) => "Тиждень ${week}";

  static String m75(name) => "Ласкаво просимо, ${name}";

  static String m76(count) => "Ви обираєте ${count} товарів";

  static String m77(type) => "Ви пройшли ${type}";

  static String m78(point) => "У вас є ${point} балів";

  static String m79(price) => "Ви заощадили ${price}";
