...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Sunt necesare minimum ${count} caractere";
  ...
  static String m46(value) => "Tranzacție minimă: ${value}";

  static String m47(store) => "Mai multe de la ${store}";

  static String m48(number) => "Trebuie cumpărat în grupuri de ${number}";

  static String m49(itemCount) => "${itemCount} articole";

  static String m50(amount) => "Plătește ${amount}";

  static String m51(date) => "Plata scadentă: ${date}";

  static String m52(name) => "${name} a fost adăugat în coș cu succes";

  static String m53(total) => "Cantitate: ${total}";

  static String m54(name) => "A primit bani de la ${name}";

  static String m55(count) =>
      "Vrei să elimini ${count} produs(e) din lista ta de dorințe?";

  static String m56(percent) => "Reducere ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} articol)";

  static String m58(keyword, count) => "${keyword} (${count} articole)";

  static String m59(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m60(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m61(price) => "Începând de la ${price}";

  static String m62(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m63(total) => "${total} produse";

  static String m64(name) => "Transferă bani către ${name}";

  static String m65(price) => "Până la ${price}";

  static String m66(amount) => "Folosiți ${amount} puncte";
  ...
  static String m68(time) => "Valabil până la: ${time}";

  static String m69(date) => "Valabil până la ${date}";

  static String m70(number) => "Versiunea ${number}";

  static String m71(balance) => "Sold portofel: ${balance}";

  static String m72(message) => "Atenție: ${message}";
  ...
  static String m74(week) => "Săptămâna ${week}";

  static String m75(name) => "Bun venit, ${name}";

  static String m76(count) => "Selectezi ${count} produs(e)";

  static String m77(type) => "Ai trecut de ${type}";

  static String m78(point) => "Ai ${point} puncte";

  static String m79(price) => "Ai economisit ${price}";
