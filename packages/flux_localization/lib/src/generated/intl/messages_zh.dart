...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m40(maxQuantity) => "购物车中允许的最大数量为${maxQuantity}";

  static String m41(name, formattedPrice) => "${name}：${formattedPrice}";

  static String m42(currency, amount) => "使用此支付方式的最小金额为${currency} ${amount}";

  static String m43(count) => "至少需要 ${count} 个字符";

  static String m44(storeName, minOrderAmount) =>
      " ${storeName} 的最低订购金额为 ${minOrderAmount}。请从该商店添加更多商品！";

  static String m45(amount) => "此优惠券要求最低购买金额为 ${amount}。";

  static String m46(value) => "最低交易次数： ${value}";

  static String m47(store) => "${store}的更多商品";

  static String m48(number) => "必须按${number}件为单位购买";

  static String m49(itemCount) => "${itemCount} 件商品";

  static String m50(amount) => "支付${amount}";

  static String m51(date) => "付款截止日期：${date}";

  static String m52(name) => "已将${name}添加到购物车";

  static String m53(total) => "数量：${total}";

  static String m54(name) => "已收到来自${name}的款项";

  static String m55(count) => "是否要从心愿单中移除${count}件商品？";

  static String m56(percent) => "优惠 ${percent}%";

  static String m57(keyword, count) => "${keyword}（${count}项）";

  static String m58(keyword, count) => "${keyword}（${count}项）";

  static String m59(totalCartQuantity) => "购物车，${totalCartQuantity} 件商品";

  static String m60(numberOfUnitsSold) => "已售出：${numberOfUnitsSold}";

  static String m61(price) => "起价 ${price}";

  static String m62(fieldName) => "${fieldName}为必填项";

  static String m63(total) => "${total} 个商品";

  static String m64(name) => "转账给${name}";

  static String m65(price) => "最高 ${price}";

  static String m66(amount) => "使用 ${amount} 积分";

  static String m67(maxPointDiscount, maxPriceDiscount) =>
      "使用${maxPointDiscount}积分可获得此订单${maxPriceDiscount}的折扣！";

  static String m68(time) => "有效期至: ${time}";

  static String m69(date) => "有效期至 ${date}";

  static String m70(number) => "版本 ${number}";

  static String m71(balance) => "钱包余额：${balance}";

  static String m72(message) => "警告：${message}";

  static String m73(defaultCurrency) => "当前选择的货币不支持钱包功能，请改为${defaultCurrency}";

  static String m74(week) => "第 ${week} 周";

  static String m75(name) => "欢迎，${name}";
  ...
  static String m79(price) => "您已节省${price}";
