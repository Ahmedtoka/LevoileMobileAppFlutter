...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m43(count) => "Je vyžadováno minimálně ${count} znaků";
  ...
  static String m46(value) => "Minimální transakce: ${value}";

  static String m47(store) => "Další od ${store}";

  static String m48(number) => "Musí být zakoupeno v množství po ${number}";

  static String m49(itemCount) => "Položky: ${itemCount}";

  static String m50(amount) => "Zaplatit ${amount}";

  static String m51(date) => "Platba do: ${date}";

  static String m52(name) => "Produkt ${name} byl přidán do košíku";

  static String m53(total) => "Množství: ${total}";

  static String m54(name) => "Přijaty peníze od uživatele ${name}";

  static String m55(count) =>
      "Chcete odebrat položky (celkem ${count}) ze seznamu přání?";

  static String m56(percent) => "Sleva ${percent}%";

  static String m57(keyword, count) => "${keyword} (${count} položka)";

  static String m58(keyword, count) => "${keyword} (${count} položek)";

  static String m59(totalCartQuantity) =>
      "Nákupní košík, ${totalCartQuantity} položek";

  static String m60(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m61(price) => "Začíná od ${price}";

  static String m62(fieldName) => "Pole ${fieldName} je povinné";

  static String m63(total) => "${total} produktů";

  static String m64(name) => "Převést peníze uživateli ${name}";

  static String m65(price) => "Až do ${price}";

  static String m66(amount) => "Použijte ${amount} bodů";
  ...
  static String m70(number) => "Verze ${number}";

  static String m71(balance) => "Zůstatek v peněžence: ${balance}";

  static String m72(message) => "Upozornění: ${message}";
  ...
  static String m74(week) => "Týden ${week}";

  static String m75(name) => "Vítejte, ${name}";

  static String m76(count) => "Vybíráte položky (celkem ${count})";

  static String m77(type) => "Splnili jste ${type}";

  static String m78(point) => "Máte ${point} bodů";

  static String m79(price) => "Ušetřili jste ${price}";
