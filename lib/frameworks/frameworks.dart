  ...
  Widget renderProductDescription(BuildContext context, String description) {
    return HtmlWidget(
      ...
      textStyle: Theme.of(context).textTheme.bodyMedium!
          .copyWith(color: Theme.of(context).colorScheme.onSurface, height: 1.5)
          .apply(fontSizeFactor: 1.1),
      // Present Shopify tables (e.g. size charts) full-width with clean borders,
      // closer to the website. Content is unchanged — only neatly styled.
      customStylesBuilder: (element) {
        switch (element.localName) {
          case 'table':
            return {
              'width': '100%',
              // Equal column widths so one column can't squeeze the headers
              // onto two lines.
              'table-layout': 'fixed',
          ...
          case 'th':
            return {
              ...
              // Tighter padding + smaller header text so labels like
              // "Length (cm)" fit on a single line.
              'padding': '7px 3px',
              'text-align': 'center',
              'font-size': '12px',
              'line-height': '1.25',
