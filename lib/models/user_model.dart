...
class UserModel with ChangeNotifier {
  ...
  Future<void> _saveUser(User? user) async {
    try {
      ...
      // Le Voile analytics: report a login when a user becomes logged in.
      if (hasUser) {
        CouponService.instance.track('login', email: user.email);
      }
  ...
  Future<void> createUser({
    ...
    try {
      ...
      await _saveUser(user);
      // Le Voile analytics: report a new account creation.
      CouponService.instance.track('signup', email: user?.email);
      success(user);
