            ...
            if (isVisibleBuyButton &&
              ...
              ValueListenableBuilder(
                ...
                builder: (_, position, __) {
                  ...
                  // As the bar slides down to hide, also slide it past the
                  // system nav bar so it disappears completely (the bar is
                  // taller now by bottomSafe).
                  final hiddenExtra = bottomSafe *
                      (position.abs() / _kSizeBttomWidget).clamp(0.0, 1.0);
                  return Positioned(
                    bottom: sizeKeyboard > 0
                        ? sizeKeyboard
                        : position - hiddenExtra,
                    child: Container(
