...
import '../../custom/about_screen.dart';
      ...
      case 'rating':
        {
          ...
          onTap = () async {
            // Open the real store page (set in the dashboard once live);
            // fall back to the default rate flow if it's not configured yet.
            final url = await AppUpdateService.rateUrl();
