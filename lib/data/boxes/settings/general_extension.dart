...
extension GeneralSettings on SettingsBox {
  ...
  /// Le Voile: splash slogan (under the logo), editable from the dashboard.
  /// Cached so it's available before the remote config loads on next launch.
  String get splashSlogan {
    return box.get(
      'lv_splash_slogan',
      defaultValue: 'M O D E S T   E L E G A N C E',
    );
  }

  set splashSlogan(String value) {
    box.put('lv_splash_slogan', value);
  }
